      ...
      if (purchaseDetails.status == PurchaseStatus.pending) {
        ...
        if (purchaseDetails.status == PurchaseStatus.error) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
                content: Text(l10n.iapTransactionError(
  ...
  Future<void> _verifyPurchase(PurchaseDetails purchaseDetails) async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(result.data['message'] ?? l10n.loginSuccess),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(l10n.iapVerificationError(e.message ?? '')),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(l10n.iapUnknownError(e.toString())),
              backgroundColor: Colors.red),
        );
      }
    } finally {
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(l10n.iapProcessingTransaction,
